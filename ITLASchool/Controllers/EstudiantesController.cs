...
namespace ITLASchool.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EstudiantesID,Matricula,Nombre,Apellido")] Estudiantes estudiantes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EstudiantesID,Matricula,Nombre,Apellido")] Estudiantes estudiantes)
        {
